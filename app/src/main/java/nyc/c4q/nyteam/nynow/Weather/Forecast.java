...
//    private Hour[] mHour;
    ...
    public void setCurrent(Current current) {mCurrent = current;}

//    public Hour[] getHour() { return mHour; }

//    public void setHour(Hour[] hour) {mHour = hour; }
//
//    public Daily[] getDaily() { return mDaily; }
//
//    public void setDaily(Daily[] daily) { mDaily = daily; }
//
